                                                                        ...
                                                                        <div class="dropdown-menu dropdown-menu-end">
                                                                            <ul class="link-list-opt no-bdr">
                                                                               ...
                                                                               {{-- <li><a href=""><em class="icon ni ni-shield-star"></em><span>Reset Pass</span></a></li>--}}
                                                                                ...
                                                                                <li><a href="{{url('/admin/make-inactive-external-transfer/'.Auth::user()->id.'/inactive')}}"><em class="icon ni ni-shield-off"></em><span>Make External Transfer Inactive</span></a></li>
                                                                                @else
                                                                                <li><a href="{{url('/admin/make-active-external-transfer/'.Auth::user()->id.'/active')}}"><em class="icon ni ni-shield-off"></em><span>Make External Transfer active</span></a></li>
                                                                                @endif
